...
dist: 
	@test -d .tmp/tp21.0.0 || mkdir -p .tmp/tp21.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tp21.0.0/ && $(COPY_FILE) --parents gestionnaire.qrc .tmp/tp21.0.0/ && $(COPY_FILE) --parents openglwindow.h gamewindow.h camera.h .tmp/tp21.0.0/ && $(COPY_FILE) --parents openglwindow.cpp gamewindow.cpp camera.cpp main.cpp .tmp/tp21.0.0/ && (cd `dirname .tmp/tp21.0.0` && $(TAR) tp21.0.0.tar tp21.0.0 && $(COMPRESS) tp21.0.0.tar) && $(MOVE) `dirname .tmp/tp21.0.0`/tp21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tp21.0.0
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/home/mewsette/Documents/moteur/2tp/hmin317-tp2/. || mkdir -p $(INSTALL_ROOT)/home/mewsette/Documents/moteur/2tp/hmin317-tp2/.
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/home/mewsette/Documents/moteur/2tp/hmin317-tp2/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/home/mewsette/Documents/moteur/2tp/hmin317-tp2/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/home/mewsette/Documents/moteur/2tp/hmin317-tp2/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/home/mewsette/Documents/moteur/2tp/hmin317-tp2/./ 
